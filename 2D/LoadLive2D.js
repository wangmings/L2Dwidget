...
, function(t, n, e) {
    ...
    (t.exports = function(t, n, e, u) {
        ...
        t[n] !== e && (a && (i(e, c) || o(e, c, t[n] ? "" + t[n] : f.join(String(n)))),
...
, function(t, n, e) {
    var r = e(1)
      ...
      , a = "prototype"
      , f = function(t, n, e) {
        var s, l, p, v, d = t & f.F, h = t & f.G, y = t & f.S, b = t & f.P, w = t & f.B, m = h ? r : y ? r[n] || (r[n] = {}) : (r[n] || {})[a], x = h ? o : o[n] || (o[n] = {}), g = x[a] || (x[a] = {});
        h && (e = n);
        for (s in e)
...
, function(t, n, e) {
    ...
    t.exports = function(t, n, e, y, b, w, m) {
        ...
        }, O = n + " Iterator", P = b == d, k = !1, S = t.prototype, T = S[p] || S["@@iterator"] || b && S[b], L = !v && T || j(b), E = b ? P ? j("entries") : L : void 0, M = "Array" == n ? S.entries || T : T;
        if (M && (_ = l(M.call(new t))) !== Object.prototype && _.next && (s(_, O, !0),
        r || u(_, p) || c(_, p, h)),
        P && T && T.name !== d && (k = !0,
        L = function() {
            return T.call(this)
...
, function(t, n, e) {
    var r, o, i, c = e(14), u = e(78), a = e(36), f = e(19), s = e(1), l = s.process, p = s.setImmediate, v = s.clearImmediate, d = s.MessageChannel, h = s.Dispatch, y = 0, b = {}, w = "onreadystatechange", m = function() {
        var t = +this;
    ...
    : d ? (i = (o = new d).port2,
    o.port1.onmessage = x,
    r = c(i.postMessage, i, 1)) : s.addEventListener && "function" == typeof postMessage && !s.importScripts ? (r = function(t) {
        s.postMessage(t + "", "*")
    }
    ,
...
, function(t, n, e) {
    "use strict";
    var r, o, i, c, u = e(32), a = e(1), f = e(14), s = e(17), l = e(13), p = e(6), v = e(15), d = e(73), h = e(74), y = e(37), b = e(38).set, w = e(79)(), m = e(25), x = e(39), g = e(40), _ = "Promise", j = a.TypeError, O = a.process, P = a[_], k = "process" == s(O), S = function() {}, T = o = m.f, L = !!function() {
        try {
            var t = P.resolve(1)
            ...
            w(function() {
                for (var r = t._v, o = 1 == t._s, i = 0, c = function(n) {
                    ...
                    try {
                        ...
                        e = c(r),
                        f && f.exit()),
                        e === n.promise ? a(j("Promise-chain cycle")) : (i = E(e)) ? i.call(e, u, a) : u(e)) : a(r)
                    } catch (t) {
                        a(t)
                    }
                }; e.length > i; )
    ...
    (n = t.exports = function(t, n, e, l, p) {
        ...
        if (i(b)) {
            for (v = u(t.length); v > m; m++)
                if ((y = n ? w(c(d = t[m])[0], d[1]) : w(t[m])) === f || y === s)
                    return y
        } else
...
, function(t, n, e) {
    ...
    // e.p = r().replace(/[^/\\\\]+$/, ""),
    // console.log("Live2Dwidget: publicPath: " + e.p),
    // n.getCurrentPath = r
}
, function(t, n, e) {
    "use strict";
      ...
      , f = new (function() {
        ...
        return o(t, [{
            ...
            value: function() {
                ...
                (0,
                u.configApplyer)(t),
                !u.config.mobile.show && c.default.mobile() || e.e(0).then(e.bind(null, 131)).then(function(t) {
                    (a = t).theRealInit()
                }).catch(function(t) {
                    console.error(t)
                })
...
, function(t, n, e) {
    ...
    i.cordova() && p("cordova");
    function d() {
        i.landscape() ? (v("portrait"),
        p("landscape"),
        h("landscape")) : (v("landscape"),
        p("portrait"),
        h("portrait")),
        w()
    }
...
, function(t, n, e) {
    ...
    t.exports = function(t) {
        var n = this.__data__
          , e = r(n, t);
        return !(e < 0 || (e == n.length - 1 ? n.pop() : o.call(n, e, 1),
        --this.size,
        0))
    }
}
        ...
        if (j)
            ...
            if (P) {
                var k = f(_)
                  ...
                  , T = !k && !S && h(_);
                O = _,
                k || S || T ? f(g) ? O = g : s(g) ? O = c(g) : S ? (P = !1,
                O = o(_, !0)) : T ? (P = !1,
                O = i(_, !0)) : O = [] : d(_) || a(_) ? (O = g,
                a(g) ? O = y(g) : (!v(g) || b && p(g)) && (O = u(_))) : P = !1
            }
            P && (x.set(_, O),
            w(O, _, b, m, x),
            x.delete(_)),
    ...
    t.exports = function(t) {
        return r(function(n, e) {
            var r = -1
              ...
              , c = i > 1 ? e[i - 1] : void 0
              , u = i > 2 ? e[2] : void 0;
            for (c = t.length > 3 && "function" == typeof c ? (i--,
            c) : void 0,
            u && o(e[0], e[1], u) && (c = i < 3 ? void 0 : c,
            i = 1),
            n = Object(n); ++r < i; ) {
                var a = e[r];
                a && t(n, a, r, c)
