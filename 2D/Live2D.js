...
webpackJsonpL2Dwidget([0], {
    131: function(t, i, e) {
        ...
        function T(t) {
            ...
            var i = o.currCanvas.getBoundingClientRect()
              ...
              , s = L(n.x - i.left)
              , _ = M(n.y - i.top);
            h.cDefine.DEBUG_MOUSE_LOG && console.log("modelTapEvent onMouseDown device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + _ + ")"),
            e,
            r,
            $.tapEvent(s, _)
        }
            ...
            if ("mousedown" == t.type)
                ...
                !function(t) {
                    ...
                    var i = o.currCanvas.getBoundingClientRect()
                      ...
                      , s = L(n.x - i.left)
                      , _ = M(n.y - i.top);
                    h.cDefine.DEBUG_MOUSE_LOG && console.log("modelTurnHead onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + _ + ")"),
                    e,
                    r,
                    p.setPoint(s, _)
                }(t);
        ...
        function v(t) {
            ...
            "touchstart" == t.type ? 1 == t.touches.length && T(i) : "touchmove" == t.type ? function(t) {
                var i = o.currCanvas.getBoundingClientRect()
                  ...
                  , s = L(n.x - i.left)
                  , _ = M(n.y - i.top);
                h.cDefine.DEBUG_MOUSE_LOG && console.log("followPointer onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + _ + ")"),
                y && (e,
                r,
                p.setPoint(s, _))
            }(i) : "touchend" == t.type && P()
        ...
        i.theRealInit = function() {
            (0,
            o.createElement)(),
            o.currCanvas.addEventListener && (window.addEventListener("click", S),
            ...
            c.setMaxScreenRect(h.cDefine.VIEW_LOGICAL_MAX_LEFT, h.cDefine.VIEW_LOGICAL_MAX_RIGHT, h.cDefine.VIEW_LOGICAL_MAX_BOTTOM, h.cDefine.VIEW_LOGICAL_MAX_TOP),
            ...
            d = r.config.modelConfig.modelPath,
            ...
            function t() {
                ...
                i(t, o.currCanvas),
                void 0 !== l && (l(o.currCanvas.toDataURL()),
                l = void 0)
            }())
        }
        ,
    ...
    132: function(t, i, e) {
        ...
        (function(t) {
            ...
            r.prototype.getModelImpl = function() {
                return null == this._$MT && (this._$MT = new l,
                this._$MT._$zP()),
                this._$MT
            }
            ,
                ...
                if (0 != e)
                    if (1 == t.length) {
                        ...
                        this.getPartsOpacity(p))
                          , a = e / r;
                        s ? (_ += a) > 1 && (_ = 1) : (_ -= a) < 0 && (_ = 0),
                        this.setPartsOpacity(p, _)
                    } else {
                        ...
                        for (l = 0; l < t.length; l++) {
                            p = i[l];
                            if (o == l)
                                this.setPartsOpacity(p, n);
                            else {
                                var h, $ = this.getPartsOpacity(p);
                                (1 - (h = n < .5 ? -.5 * n / .5 + 1 : .5 * (1 - n) / .5)) * (1 - n) > .15 && (h = 1 - .15 / (1 - n)),
                                $ > h && ($ = h),
                ...
                for (var r = 0, n = 0; n < o.CHANNEL_COUNT; n++) {
                    ...
                    if (0 == s)
                        ...
                        for (a = 0; a < s; a++) {
                            ...
                            (l = this.clipContextList[r++]).layoutChannelNo = n,
                            l.layoutBounds.x = .5 * $,
                            l.layoutBounds.y = .5 * h,
                            l.layoutBounds.width = .5,
                            l.layoutBounds.height = .5
                        }
                    else if (s <= 9)
                        for (a = 0; a < s; a++) {
                            var $;
            ...
            s.prototype.updateParam = function(t, i) {
                if (i._$AT && !i._$9L) {
                    ...
                    var o = this._$V0;
                    0 <= (o = o * (0 == this._$dP ? 1 : at._$r2((e - i._$bs) / this._$dP)) * (0 == this._$eo || i._$Do < 0 ? 1 : at._$r2((i._$Do - e) / this._$eo))) && o <= 1 || console.log("### assert!! ### "),
            ...
            u.prototype._$oo = function(t, i) {
                ...
                this.p1._$xT();
                var r, o, n = -Math.atan2(this.p1.y - this.p2.y, this.p1.x - this.p2.x), s = Math.cos(n), _ = Math.sin(n), a = 9.8 * this.p2._$p, h = this._$Db * vt._$bS, $ = a * Math.cos(n - h);
                r = $ * _,
                o = $ * s;
            ...
            T._$ni = function(t, i, e, r, o, n, s, _, a) {
                ...
                if (0 == h)
                    return null;
                var $, l = ((t - e) * n - (i - r) * o) / h;
                return $ = 0 != o ? (t - e - l * s) / o : (i - r - l * _) / n,
                isNaN($) && ($ = (t - e - l * s) / o,
                isNaN($) && ($ = (i - r - l * _) / n),
                isNaN($) && (console.log("a is NaN @UtVector#_$ni() "),
                console.log("v1x : " + o),
                console.log("v1x != 0 ? " + (0 != o)))),
                null == a ? new Array($,l) : (a[0] = $,
                a[1] = l,
                a)
            }
            ;
            ...
            S._$Z2 = function(t, i, e, r) {
                ...
                if (4 == o) {
                    var S, v = r[n[0]], L = r[n[1]], M = r[n[2]], E = r[n[3]], A = r[n[4]], I = r[n[5]], x = r[n[6]], w = r[n[7]], D = r[n[8]], O = r[n[9]], R = r[n[10]], b = r[n[11]], F = r[n[12]], C = r[n[13]], N = r[n[14]], B = r[n[15]], G = (l = s[0],
                    u = s[1],
                    P = s[2],
                    s[3]);
            ...
            S._$Vr = function(t, i, e, r, o, n, s, _) {
                ...
                if (a <= 0) {
                    ...
                    var k, V, X = o[h[0]], z = o[h[1]], H = o[h[2]], W = o[h[3]], j = o[h[4]], q = o[h[5]], J = o[h[6]], Q = o[h[7]], Z = o[h[8]], K = o[h[9]], tt = o[h[10]], it = o[h[11]], et = o[h[12]], rt = o[h[13]], ot = o[h[14]], nt = o[h[15]], st = (m = $[0],
                    R = $[1],
                    $[2]), _t = $[3], at = 1 - _t, ht = at * (V = 1 - st) * (k = 1 - R) * (g = 1 - m), $t = at * V * k * m, lt = at * V * R * g, ut = at * V * R * m, pt = at * st * k * g, ct = at * st * k * m, ft = at * st * R * g, gt = at * st * R * m, yt = _t * V * k * g, dt = _t * V * k * m, mt = _t * V * R * g, Tt = _t * V * R * m, Pt = _t * st * k * g, St = _t * st * k * m, vt = _t * st * R * g, Lt = _t * st * R * m;
                    for (c = 0; c < l; )
                        n[u] = ht * X[c] + $t * z[c] + lt * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + yt * Z[c] + dt * K[c] + mt * tt[c] + Tt * it[c] + Pt * et[c] + St * rt[c] + vt * ot[c] + Lt * nt[c],
                        ++c,
                        n[u + 1] = ht * X[c] + $t * z[c] + lt * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + yt * Z[c] + dt * K[c] + mt * tt[c] + Tt * it[c] + Pt * et[c] + St * rt[c] + vt * ot[c] + Lt * nt[c],
                        ++c,
                        u += _
                } else {
            ...
            D.prototype._$Q2 = function(t, i) {
                for (var e, r, o = this._$Ob.length, n = t._$v2(), s = 0, _ = 0; _ < o; _++) {
                    var a = this._$Ob[_];
                    if ((e = a.getParamIndex(n)) == x._$ds && (e = t.getParamIndex(a.getParamID()),
                    a._$Pb(e, n)),
                    e < 0)
            ...
            b.prototype._$RT = function(t) {
                ...
                var i = t[0]
                  ...
                  , n = Math.sqrt(i * i + r * r)
                  , s = i * o - e * r;
                0 == n ? _t._$so && console.log("affine._$RT() / rt==0") : (t[0] = n,
                t[1] = s / n,
                t[2] = (r * o + i * e) / s,
                t[3] = Math.atan2(r, i))
            }
            ...
            ;
            function F() {
                e || (s.prototype.constructor.call(this),
                        ...
                        if ("#" != n)
                            if ("$" != n) {
                                if ("a" <= n && n <= "z" || "A" <= n && n <= "Z" || "_" == n) {
                                    ...
                                    if ($ >= 0) {
                                        var s = new N;
                                        w.startsWith(t, h, F._$cs) ? (s._$RP = N._$hs,
                                        s._$4P = new String(t,h,$ - h)) : w.startsWith(t, h, F._$ar) ? (s._$4P = new String(t,h + 7,$ - h - 7),
                                        w.startsWith(t, h + 7, "ANCHOR_X") ? s._$RP = N._$xs : w.startsWith(t, h + 7, "ANCHOR_Y") ? s._$RP = N._$us : w.startsWith(t, h + 7, "SCALE_X") ? s._$RP = N._$qs : w.startsWith(t, h + 7, "SCALE_Y") ? s._$RP = N._$Ys : w.startsWith(t, h + 7, "X") ? s._$RP = N._$ws : w.startsWith(t, h + 7, "Y") && (s._$RP = N._$Ns)) : (s._$RP = N._$Fr,
                                ...
                                var l = !1;
                                if ($ >= 0)
                                    for ($ == h + 4 && "f" == t[h + 1] && "p" == t[h + 2] && "s" == t[h + 3] && (l = !0),
                                    o = $ + 1; o < r && ("\r" != (n = 255 & t[o]) && "\n" != n); ++o)
                                        if ("," != n && " " != n && "\t" != n) {
            ...
            U.prototype.update = function() {
                ...
                U._$e && _.dump("_$DL"),
                U._$e && _.start("_$eL");
                for (i = this._$Js.length - 1; i >= 0; i--)
                    this._$Js[i] = U._$jr;
                return this._$QT = !1,
                U._$e && _.dump("_$eL"),
                !1
            ...
            k.prototype._$7T = function(t) {
                ...
                case STATE_CLOSING:
                    ...
                    break;
                case STATE_CLOSED:
                    (r = (e - this._$bb) / this._$Cb) >= 1 && (this._$_L = V.STATE_OPENING,
                    this._$bb = e),
                    i = 0;
                    break;
                case STATE_OPENING:
                    ...
                    break;
                case STATE_INTERVAL:
                    this._$12 < e && (this._$_L = V.STATE_CLOSING,
                    this._$bb = e),
                    i = 1;
                    break;
                case STATE_FIRST:
            ...
            function X() {
                e || (M.prototype.constructor.call(this),
            ...
            ,
            X._$cr = function(t, i) {
                return null == t || t._$yL() < i.length ? ((t = X._$9r(2 * i.length)).put(i),
                t._$oT(0)) : (t.clear(),
                t.put(i),
                t._$oT(0)),
                t
            ...
            ,
            X._$mb = function(t, i) {
                return null == t || t._$yL() < i.length ? ((t = X._$vb(2 * i.length)).put(i),
                t._$oT(0)) : (t.clear(),
                t.put(i),
                t._$oT(0)),
                t
            ...
            ;
            function z() {
                e || (A.prototype.constructor.call(this),
                this._$GS = null,
                this._$Y0 = null)
            }
            z.prototype = new A,
            ...
            z.prototype._$Nr = function(t, i) {
                ...
                if (this._$GS._$Ur(t)) {
                    ...
                    o <= 0) {
                        ...
                        e._$Yr._$fL = (1 - k) * ((1 - v) * (p + (c - p) * u) + v * (L + (M - L) * u)) + k * ((1 - v) * (V + (X - V) * u) + v * (H + (W - H) * u)),
                        ...
                        e._$Yr._$gL = (1 - k) * ((1 - v) * (p + (c - p) * u) + v * (L + (M - L) * u)) + k * ((1 - v) * (V + (X - V) * u) + v * (H + (W - H) * u)),
                        ...
                        e._$Yr._$B0 = (1 - k) * ((1 - v) * (p + (c - p) * u) + v * (L + (M - L) * u)) + k * ((1 - v) * (V + (X - V) * u) + v * (H + (W - H) * u)),
                        ...
                        e._$Yr._$z0 = (1 - k) * ((1 - v) * (p + (c - p) * u) + v * (L + (M - L) * u)) + k * ((1 - v) * (V + (X - V) * u) + v * (H + (W - H) * u)),
                        ...
                        e._$Yr._$qT = (1 - k) * ((1 - v) * (p + (c - p) * u) + v * (L + (M - L) * u)) + k * ((1 - v) * (V + (X - V) * u) + v * (H + (W - H) * u))
                    } else {
            ...
            z.prototype._$2b = function(t, i) {
                ...
                this._$32()) {
                    ...
                    if (e._$8r == A._$ur && (e._$8r = t.getBaseDataIndex(r)),
                    e._$8r < 0)
                        _t._$so && _._$li("_$L _$0P _$G :: %s", r),
                        e._$hS(!1);
                    else {
            ...
            z.prototype._$nb = function(t, i, e, r, o, n, s) {
                this != i._$GT() && console.log("### assert!! ### ");
                for (var _, a, h = i, $ = null != h._$Wr ? h._$Wr : h._$Yr, l = Math.sin(vt._$bS * $._$qT), u = Math.cos(vt._$bS * $._$qT), p = h.getTotalScale(), c = $.reflectX ? -1 : 1, f = $.reflectY ? -1 : 1, g = u * p * c, y = -l * p * f, d = l * p * c, m = u * p * f, T = $._$fL, P = $._$gL, S = o * s, v = n; v < S; v += s)
                    _ = e[v],
                    a = e[v + 1],
                    r[v] = g * _ + y * a + T,
                    r[v + 1] = d * _ + m * a + P
            ...
            H.prototype = new st;
            function W() {
                e || (L.prototype.constructor.call(this),
                this._$gP = null,
                this._$dr = null,
                this._$GS = null,
                this._$qb = null,
            ...
            ;
            function q() {
                e || (r.prototype.constructor.call(this),
                this._$zo = new X)
            }
            q.prototype = new r,
                        ...
                        if ("#" != n)
                            if ("$" != n) {
                                if (97 <= s && s <= 122 || 65 <= s && s <= 90 || "_" == n) {
                                    ...
                                    if (u >= 0) {
                                        var _ = new N;
                                        w.startsWith(t, l, J._$cs) ? (_._$RP = N._$hs,
                                        _._$4P = w.createString(t, l, u - l)) : w.startsWith(t, l, J._$ar) ? (_._$4P = w.createString(t, l + 7, u - l - 7),
                                        w.startsWith(t, l + 7, "ANCHOR_X") ? _._$RP = N._$xs : w.startsWith(t, l + 7, "ANCHOR_Y") ? _._$RP = N._$us : w.startsWith(t, l + 7, "SCALE_X") ? _._$RP = N._$qs : w.startsWith(t, l + 7, "SCALE_Y") ? _._$RP = N._$Ys : w.startsWith(t, l + 7, "X") ? _._$RP = N._$ws : w.startsWith(t, l + 7, "Y") && (_._$RP = N._$Ns)) : (_._$RP = N._$Fr,
                                ...
                                var p = !1;
                                if (u >= 0)
                                    for (u == l + 4 && "f" == Q(t, l + 1) && "p" == Q(t, l + 2) && "s" == Q(t, l + 3) && (p = !0),
                                    o = u + 1; o < r && ("\r" != (n = Q(t, o)) && "\n" != n); ++o)
                                        if ("," != n && " " != n && "\t" != n) {
                ...
                for (var h, $, l, u = r * n, p = 0, c = 0, f = 0, g = 0, y = 0, d = 0, m = !1, T = o; T < u; T += n) {
                    ...
                    (P = v * _) < 0 || S < 0 || _ <= P || a <= S) {
                        ...
                        if (!m) {
                            ...
                            c = .25 * (s[2 * (0 + 0 * M) + 1] + s[2 * (_ + 0 * M) + 1] + s[2 * (0 + a * M) + 1] + s[2 * (_ + a * M) + 1]);
                            ...
                            if (v <= 0)
                                if (L <= 0) {
                                    var w = s[2 * (0 + 0 * M)]
                                      ...
                                      , C = p - 2 * f - 2 * y
                                      , N = c - 2 * g - 2 * d;
                                    (B = .5 * (v - -2)) + (G = .5 * (L - -2)) <= 1 ? (e[T] = C + (b - C) * B + (O - C) * G,
                                    e[T + 1] = N + (F - N) * B + (R - N) * G) : (e[T] = w + (O - w) * (1 - B) + (b - w) * (1 - G),
                                    ...
                                    O = p - 2 * f + 3 * y,
                                    R = c - 2 * g + 3 * d;
                                    (B = .5 * (v - -2)) + (G = .5 * (L - 1)) <= 1 ? (e[T] = C + (b - C) * B + (O - C) * G,
                                    e[T + 1] = N + (F - N) * B + (R - N) * G) : (e[T] = w + (O - w) * (1 - B) + (b - w) * (1 - G),
                                    e[T + 1] = D + (R - D) * (1 - B) + (F - D) * (1 - G))
                                } else {
                                    (k = 0 | S) == a && (k = a - 1);
                                ...
                                if (L <= 0) {
                                    ...
                                    b = p + 3 * f - 2 * y,
                                    F = c + 3 * g - 2 * d;
                                    (B = .5 * (v - 1)) + (G = .5 * (L - -2)) <= 1 ? (e[T] = C + (b - C) * B + (O - C) * G,
                                    e[T + 1] = N + (F - N) * B + (R - N) * G) : (e[T] = w + (O - w) * (1 - B) + (b - w) * (1 - G),
                                    e[T + 1] = D + (R - D) * (1 - B) + (F - D) * (1 - G))
                                } else if (L >= 1) {
                                    C = s[2 * (_ + a * M)],
                                    ...
                                    w = p + 3 * f + 3 * y,
                                    D = c + 3 * g + 3 * d;
                                    (B = .5 * (v - 1)) + (G = .5 * (L - 1)) <= 1 ? (e[T] = C + (b - C) * B + (O - C) * G,
                                    e[T + 1] = N + (F - N) * B + (R - N) * G) : (e[T] = w + (O - w) * (1 - B) + (b - w) * (1 - G),
                                    e[T + 1] = D + (R - D) * (1 - B) + (F - D) * (1 - G))
                                } else {
                                    var k;
                        ...
                        h = 2 * ((0 | P) + (0 | S) * (_ + 1)),
                        ($ = P - (0 | P)) + (l = S - (0 | S)) < 1 ? (e[T] = s[h] * (1 - $ - l) + s[h + 2] * $ + s[h + 2 * (_ + 1)] * l,
                        e[T + 1] = s[h + 1] * (1 - $ - l) + s[h + 3] * $ + s[h + 2 * (_ + 1) + 1] * l) : (e[T] = s[h + 2 * (_ + 1) + 2] * ($ - 1 + l) + s[h + 2 * (_ + 1)] * (1 - $) + s[h + 2] * (1 - l),
                        e[T + 1] = s[h + 2 * (_ + 1) + 3] * ($ - 1 + l) + s[h + 2 * (_ + 1) + 1] * (1 - $) + s[h + 3] * (1 - l))
                }
            }
            ,
            Z.prototype.transformPoints_sdk1 = function(t, i, e, r, o, n, s) {
                for (var _, a, h, $, l, u, p, c = i, f = this._$o, g = this._$A, y = o * s, d = null != c._$hr ? c._$hr : c._$Cr, m = n; m < y; m += s)
                    _t._$ts ? (_ = e[m],
                    a = e[m + 1],
                    _ < 0 ? _ = 0 : _ > 1 && (_ = 1),
                    a < 0 ? a = 0 : a > 1 && (a = 1),
                    ...
                    u = _ - h,
                    p = a - $,
                    l = 2 * (h + $ * (f + 1))) : (u = (_ = e[m] * f) - (0 | _),
                    p = (a = e[m + 1] * g) - (0 | a),
                    l = 2 * ((0 | _) + (0 | a) * (f + 1))),
                    u + p < 1 ? (r[m] = d[l] * (1 - u - p) + d[l + 2] * u + d[l + 2 * (f + 1)] * p,
                    r[m + 1] = d[l + 1] * (1 - u - p) + d[l + 3] * u + d[l + 2 * (f + 1) + 1] * p) : (r[m] = d[l + 2 * (f + 1) + 2] * (u - 1 + p) + d[l + 2 * (f + 1)] * (1 - u) + d[l + 2] * (1 - p),
                    r[m + 1] = d[l + 2 * (f + 1) + 3] * (u - 1 + p) + d[l + 2 * (f + 1) + 1] * (1 - u) + d[l + 3] * (1 - p))
            }
            ,
            ...
            ot.expandClip = function(t, i, e, r, o, n, s, _, a, h) {
                var $ = s - o
                  ...
                  , C = h + c * v / L
                  , N = ot._$50;
                return null != i._$P2(N) && (ot.clipWithTransform(t, N, M, E, A, I, x, w, D, O, F, C, R, b),
                !0)
            }
            ,
            ...
            ;
            function $t() {
                e || (W.prototype.constructor.call(this),
                this._$LP = -1,
                this._$d0 = 0,
                this._$Yo = 0,
                this._$JP = null,
            ...
            $t.prototype._$Nr = function(t, i) {
                ...
                !e._$IS[0])) {
                    var r = $t._$gT;
                    r[0] = !1,
                    S._$Vr(t, this._$GS, r, this._$d0, this._$Eo, e._$Cr, B._$i2, B._$No)
                }
            }
            ,
            ...
            dt._$cr = function(t, i) {
                return null == t || t._$yL() < i.length ? ((t = dt._$9r(2 * i.length)).put(i),
                t._$oT(0)) : (t.clear(),
                t.put(i),
                t._$oT(0)),
                t
            ...
            dt._$mb = function(t, i) {
                return null == t || t._$yL() < i.length ? ((t = dt._$vb(2 * i.length)).put(i),
                t._$oT(0)) : (t.clear(),
                t.put(i),
                t._$oT(0)),
                t
            ...
            dt.prototype._$Uo = function(t, i, e, r, o, n, s, _) {
                if (!(n < .01 && null == this.clipBufPre_clipContextMask)) {
                    ...
                    if (null != this.clipBufPre_clipContextMask) {
                        ...
                        a.uniform4f(this.u_baseColor_Loc, 2 * f.x - 1, 2 * f.y - 1, 2 * f._$EL() - 1, 2 * f._$5T() - 1),
            ...
            Mt.setup = function() {
                ...
                if ((e = t.indexOf("iPhone OS ")) >= 0)
                    r.os = "iPhone",
                    r._isIPhone = !0,
                    r.version = i(t, e + "iPhone OS ".length);
                else if ((e = t.indexOf("iPad")) >= 0) {
                    if ((e = t.indexOf("CPU OS")) < 0)
                        return void _._$li(" err : " + t + " @UtHtml5.setup()");
                    r.os = "iPad",
                    r._isIPad = !0,
                    r.version = i(t, e + "CPU OS ".length)
                } else
                    (e = t.indexOf("Android")) >= 0 ? (r.os = "Android",
                    r._isAndroid = !0,
                    r.version = i(t, e + "Android ".length)) : (r.os = "-",
                    r.version = -1)
            }
            ,
            _t.init();
    ...
    133: function(t, i, e) {
        ...
        o.prototype.loadModelData = function(t, i) {
            ...
            e.loadLive2DModel(t, function(t) {
                ...
                0 == r.Live2D.getError() ? (o.modelMatrix = new l(o.live2DModel.getCanvasWidth(),o.live2DModel.getCanvasHeight()),
                o.modelMatrix.setWidth(2),
                o.modelMatrix.setCenterPosition(0, 0),
                i(o.live2DModel)) : console.error("Error : Failed to loadModelData().")
            })
        }
        ,
        ...
        a.prototype.updateParam = function(t) {
            ...
            case h.STATE_CLOSING:
                (o = (e - this.stateStartTime) / this.closingMotionMsec) >= 1 && (o = 1,
                this.eyeState = h.STATE_CLOSED,
                this.stateStartTime = e),
                i = 1 - o;
                break;
            case h.STATE_CLOSED:
                (o = (e - this.stateStartTime) / this.closedMotionMsec) >= 1 && (this.eyeState = h.STATE_OPENING,
                this.stateStartTime = e),
                i = 0;
                break;
            case h.STATE_OPENING:
                (o = (e - this.stateStartTime) / this.openingMotionMsec) >= 1 && (o = 1,
                this.eyeState = h.STATE_INTERVAL,
                this.nextBlinkTime = this.calcNextBlink()),
                i = o;
                break;
            case h.STATE_INTERVAL:
                this.nextBlinkTime < e && (this.eyeState = h.STATE_CLOSING,
                this.stateStartTime = e),
                i = 1;
                break;
            case h.STATE_FIRST:
    ...
    135: function(t, i, e) {
        ...
        i.createElement = function() {
            let [canvasID,width,height,enlarge,bottom] = [
                o.config.modelConfig.canvasID,
                o.config.modelConfig.width,
                o.config.modelConfig.height,
                o.config.modelConfig.enlarge,
                o.config.modelConfig.bottom
            ];

            document.getElementById(canvasID).remove()
            var r = document.createElement("canvas");

            r.setAttribute("id", canvasID),
            r.setAttribute("width", width * enlarge),
            r.setAttribute("height", height * enlarge),
            r.style.setProperty("width", width),
            r.style.setProperty("height", height),
            r.style.setProperty("bottom", bottom + "px"),
            document.getElementById("waifu").appendChild(r),
            i.currCanvas = a = document.getElementById(canvasID),
            a.style.width = width + 'px',
            a.style.height = height + 'px',

            
            function() {
                for (var t = ["webgl2", "webgl", "experimental-webgl2", "experimental-webgl", "webkit-3d", "moz-webgl"], e = 0; e < t.length; e++)
                    try {
                ...
                _ || (console.error("Live2D widgets: Failed to create WebGL context."),
    ...
    139: function(t, i, e) {
        ...
        _.prototype.tapEvent = function(t, i) {
            ...
            for (var e = 0; e < this.models.length; e++)
                this.models[e].hitTest(s.cDefine.HIT_AREA_HEAD, t, i) ? (s.cDefine.DEBUG_LOG && console.log("Tap face."),
                this.models[e].setRandomExpression()) : this.models[e].hitTest(s.cDefine.HIT_AREA_BODY, t, i) && (s.cDefine.DEBUG_LOG && console.log("Tap body. models[" + e + "]"),
    ...
    140: function(t, i, e) {
        ...
        n.prototype.loadBytes = function(t, i) {
            ...
            let objName = getObjName(t)
            let data = loadModelData(objName[1])
            let arrayBuff = getArrayBuffer(data)
            if(bugs_c) console.log('URL: ',t,'获取对象:',arrayBuff)
        ...
        n.prototype.loadLive2DModel = function(t, i) {
            var e = null;
            this.loadBytes(t, function(t) {
                e = o.Live2DModelWebGL.loadModel(t),
                i(e)
            })
        }
        ,
        n.prototype.loadTexture = function(t, i, e, o) {
            ...
            let objName = getObjName(e);
            let imageData = loadModelData(objName[1]);
            if(bugs_c) console.log('图片: ',e,imageData);
            e = base64Blob(imageData);
    ...
    141: function(t, i, e) {
                ...
                n.loadModelData(t, function(t) {
                    for (var i = 0; i < n.modelSetting.getTextureNum(); i++) {
                        if (/^https?:\/\/|^\/\//i.test(n.modelSetting.getTextureFile(i)))
                            ...
                            o = n.modelHomeDir + n.modelSetting.getTextureFile(i);
        ...
        a.prototype.setFadeInFadeOut = function(t, i, e, r) {
            ...
            null == this.modelSetting.getMotionSound(t, i))
                ...
                let objName = getObjName(this.modelHomeDir + n);
                let audioData = loadModelData(objName[1]);
                
                if (bugs_c) console.log('音乐: ',audioData)
                _.src = base64Blob(audioData),
